...
class TestDemoClass:
    ...
    def test_WILLR(self):
        from polars_ta.momentum import WILLR
    ...
    def test_STOCHF_fastk(self):
        from polars_ta.momentum import STOCHF_fastk
    ...
    def test_STOCHF_fastd(self):
        from polars_ta.momentum import STOCHF_fastd
    ...
    def test_MACD(self):
        ...
        from polars_ta.momentum import MACD_macd
