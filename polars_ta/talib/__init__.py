...
def HT_PHASOR(close: Expr) -> Expr:  # ['inphase', 'quadrature']
    ...
    Outputs:
        ...
        quadrature
    """
    return close.map_batches(lambda x1: batches_i1_o2(x1.to_numpy().astype(float), _ta.HT_PHASOR))
...
def HT_SINE(close: Expr) -> Expr:  # ['sine', 'leadsine']
    ...
    Outputs:
        ...
        leadsine
    """
    return close.map_batches(lambda x1: batches_i1_o2(x1.to_numpy().astype(float), _ta.HT_SINE))
...
def MINMAX(close: Expr, timeperiod: int = 30) -> Expr:  # ['min', 'max']
    ...
    Outputs:
        ...
        max
    """
    return close.map_batches(lambda x1: batches_i1_o2(x1.to_numpy().astype(float), _ta.MINMAX, timeperiod))
...
def MINMAXINDEX(close: Expr, timeperiod: int = 30) -> Expr:  # ['minidx', 'maxidx']
    ...
    Outputs:
        ...
        maxidx
    """
    return close.map_batches(lambda x1: batches_i1_o2(x1.to_numpy().astype(float), _ta.MINMAXINDEX, timeperiod))
...
def AROON(high: Expr, low: Expr, timeperiod: int = 14) -> Expr:  # ['aroondown', 'aroonup']
    ...
    Outputs:
        ...
        aroonup
    """
    return struct([high, low]).map_batches(lambda xx: batches_i2_o2([xx.struct[i].to_numpy().astype(float) for i in range(2)], _ta.AROON, timeperiod))
...
def MACD(close: Expr, fastperiod: int = 12, slowperiod: int = 26, signalperiod: int = 9) -> Expr:  # ['macd', 'macdsignal', 'macdhist']
    ...
    Outputs:
        ...
        macdhist
    """
    return close.map_batches(lambda x1: batches_i1_o2(x1.to_numpy().astype(float), _ta.MACD, fastperiod, slowperiod, signalperiod))
...
def MACDEXT(close: Expr, fastperiod: int = 12, fastmatype: int = 0, slowperiod: int = 26, slowmatype: int = 0, signalperiod: int = 9, signalmatype: int = 0) -> Expr:  # ['macd', 'macdsignal', 'macdhist']
    ...
    Outputs:
        ...
        macdhist
    """
    return close.map_batches(lambda x1: batches_i1_o2(x1.to_numpy().astype(float), _ta.MACDEXT, fastperiod, fastmatype, slowperiod, slowmatype, signalperiod, signalmatype))
...
def MACDFIX(close: Expr, signalperiod: int = 9) -> Expr:  # ['macd', 'macdsignal', 'macdhist']
    ...
    Outputs:
        ...
        macdhist
    """
    return close.map_batches(lambda x1: batches_i1_o2(x1.to_numpy().astype(float), _ta.MACDFIX, signalperiod))
...
def STOCH(high: Expr, low: Expr, close: Expr, fastk_period: int = 5, slowk_period: int = 3, slowk_matype: int = 0, slowd_period: int = 3, slowd_matype: int = 0) -> Expr:  # ['slowk', 'slowd']
    ...
    Outputs:
        ...
        slowd
    """
    return struct([high, low, close]).map_batches(lambda xx: batches_i2_o2([xx.struct[i].to_numpy().astype(float) for i in range(3)], _ta.STOCH, fastk_period, slowk_period, slowk_matype, slowd_period, slowd_matype))
...
def STOCHF(high: Expr, low: Expr, close: Expr, fastk_period: int = 5, fastd_period: int = 3, fastd_matype: int = 0) -> Expr:  # ['fastk', 'fastd']
    ...
    Outputs:
        ...
        fastd
    """
    return struct([high, low, close]).map_batches(lambda xx: batches_i2_o2([xx.struct[i].to_numpy().astype(float) for i in range(3)], _ta.STOCHF, fastk_period, fastd_period, fastd_matype))
...
def STOCHRSI(close: Expr, timeperiod: int = 14, fastk_period: int = 5, fastd_period: int = 3, fastd_matype: int = 0) -> Expr:  # ['fastk', 'fastd']
    ...
    Outputs:
        ...
        fastd
    """
    return close.map_batches(lambda x1: batches_i1_o2(x1.to_numpy().astype(float), _ta.STOCHRSI, timeperiod, fastk_period, fastd_period, fastd_matype))
...
def BBANDS(close: Expr, timeperiod: int = 5, nbdevup: float = 2.0, nbdevdn: float = 2.0, matype: int = 0) -> Expr:  # ['upperband', 'middleband', 'lowerband']
    ...
    Outputs:
        ...
        lowerband
    """
    return close.map_batches(lambda x1: batches_i1_o2(x1.to_numpy().astype(float), _ta.BBANDS, timeperiod, nbdevup, nbdevdn, matype))
...
def MAMA(close: Expr, fastlimit: float = 0.5, slowlimit: float = 0.05) -> Expr:  # ['mama', 'fama']
    ...
    Outputs:
        ...
        fama
    """
    return close.map_batches(lambda x1: batches_i1_o2(x1.to_numpy().astype(float), _ta.MAMA, fastlimit, slowlimit))
