...
def WMA(close: pl.Expr, timeperiod: int = 30) -> pl.Expr:
    return close.rolling_mean(timeperiod, weights=pl.arange(1, timeperiod + 1, eager=True) / timeperiod)
...
#
#     """
#     return close.ta.KAMA(timeperiod=timeperiod, skip_nan=False)


# def MAMA(close: pl.Expr, fastlimit: float = 0.5, slowlimit: float = 0.05) -> pl.Expr:
#     pass

# def T3(close: pl.Expr, timeperiod: int = 5, vfactor: float = 0.0) -> pl.Expr:
#     pass
