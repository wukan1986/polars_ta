...
def FROMOPEN(t: Expr) -> Expr:
    ...
    df = df.with_columns(
        ...
        FROMOPEN1=FROMOPEN1(pl.col('datetime')),
    )

    shape: (6, 3)
    ┌─────────────────────┬──────────┬───────────┐
    │ datetime            ┆ FROMOPEN ┆ FROMOPEN1 │
    │ ---                 ┆ ---      ┆ ---       │
    │ datetime[μs]        ┆ i64      ┆ i64       │
    ╞═════════════════════╪══════════╪═══════════╡
    │ 2025-01-01 00:00:00 ┆ 0        ┆ 240       │
    │ 2025-01-01 09:25:00 ┆ 0        ┆ 1         │
    │ 2025-01-01 09:30:00 ┆ 1        ┆ 1         │
    │ 2025-01-01 09:31:00 ┆ 2        ┆ 2         │
    │ 2025-01-01 10:00:00 ┆ 31       ┆ 31        │
    │ 2025-01-01 13:00:00 ┆ 121      ┆ 121       │
    └─────────────────────┴──────────┴───────────┘
...
def FROMOPEN1(t: Expr) -> Expr:
    ...
    """
    return when(t.dt.time() >= time(9)).then(FROMOPEN(t).clip(1, 240)).otherwise(240)
