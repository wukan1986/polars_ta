...
lines += codegen_import_as('polars_ta.ta.overlap', include_modules=['polars_ta.wq.time_series'], include_func=['SMA', 'WMA'], include_parameter=['timeperiod'])
lines += codegen_import_as('polars_ta.ta.price', include_parameter=['timeperiod'])
lines += codegen_import_as('polars_ta.ta.statistic', include_parameter=['timeperiod'])
lines += codegen_import_as('polars_ta.ta.transform', include_modules=['polars_ta.wq.arithmetic'], include_parameter=['timeperiod'])
