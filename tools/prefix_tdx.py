...
lines += codegen_import_as('polars_ta.tdx.choice')
...
lines += codegen_import_as('polars_ta.tdx.reference', include_modules=['polars_ta.ta.overlap', 'polars_ta.ta.volatility', 'polars_ta.wq.arithmetic', 'polars_ta.wq.time_serie'], include_func=['BARSLAST', 'BARSLASTCOUNT', 'BARSSINCE', 'DMA', 'SUM_0', 'TR'], include_parameter=['N', 'd', 'timeperiod'])
lines += codegen_import_as('polars_ta.tdx.statistic', include_modules=['polars_ta.wq.time_serie'], include_parameter=['timeperiod', 'd'])
